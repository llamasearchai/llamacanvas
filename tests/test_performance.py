...
class TestPerformanceMonitor:
    ...
    def test_record_metric(self):
        ...
        assert (
            monitor.metrics["memory_usage"]["avg_value"] == 1536
        )  # Average of 1024 and 2048
...
class TestBenchmark:
    ...
    def test_run_benchmark(self):
        ...
        assert (
            benchmark.results["slow"]["avg_time"]
            > benchmark.results["fast"]["avg_time"]
        )

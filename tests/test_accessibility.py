...
class TestKeyboardNavigation:
    ...
    def test_handle_key_press(self):
        ...
        with patch.object(navigator, "focus_next") as mock_focus_next, patch.object(
            navigator, "focus_previous"
        ) as mock_focus_previous:
...
class TestColorContrast:
    ...
    def test_contrast_sufficiency(self):
        ...
        medium_contrast = is_color_contrast_sufficient(
            "#0000AA", "#CCCCCC", is_large_text=True
        )
    ...
    def test_generate_alt_text(self):
        ...
        with patch("llama_canvas.accessibility.image_captioning_model") as mock_model:
            ...
            mock_model.generate_caption.return_value = (
                "A simple image with a red square in the center"
            )
...
class TestVoiceCommands:
    ...
    def test_register_command(self):
        ...
        voice_cmd.register_commands(
            {"save file": MagicMock(), "exit program": MagicMock()}
        )
...
class TestAccessibilitySettings:
    ...
    def test_save_load_settings(self):
        ...
        with patch("llama_canvas.accessibility.json") as mock_json, patch(
            "llama_canvas.accessibility.open"
        ) as mock_open:

...
class TestSecurityManager:
    ...
    def test_authenticate_user(self):
        ...
        assert manager.authenticator.authenticate.call_args[0] == ("username", "password")
    ...
    def test_validate_input(self):
        ...
        assert manager.input_validator.validate_input.call_args[0] == ("test_input", "text")
    ...
    def test_sanitize_input(self):
        ...
        assert manager.data_sanitizer.sanitize.call_args[0][0] == "<script>alert('xss')</script>"
    ...
    def test_check_permission(self):
        ...
        assert manager.permission_manager.check_permission.call_args[0] == ("user123", "edit_image")
...
class TestDataSanitizer:
    ...
    def test_sanitize(self):
        ...
        with patch.object(sanitizer, 'sanitize_html') as mock_html, \
             patch.object(sanitizer, 'sanitize_filename') as mock_filename:
            ...
            # Test HTML sanitization
            result = sanitizer.sanitize("<script>alert('xss')</script>", input_type="html")
...
class TestValidationFunctions:
    ...
    def test_validate_file_path(self):
        ...
        valid, error = validate_file_path("image.exe", allowed_extensions=[".jpg", ".png"])
        assert valid is False
    ...
    def test_validate_image_data(self):
        ...
        with patch('llama_canvas.security.PILImage') as mock_pil:
            ...
            valid, error = validate_image_data(valid_image_data, allowed_formats=["JPEG", "PNG"])
            assert valid is False

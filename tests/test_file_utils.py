...
class TestFilePathOperations:
    ...
    def test_safe_filename(self):
        ...
        assert (
            safe_filename("  leading trailing  ") == "leading_trailing"
        )  # Trim spaces
...
class TestFileFormatValidation:
    ...
    def test_is_valid_image_format(self):
        ...
        assert (
            is_valid_image_format("test.svg", allowed_formats=[".svg", ".png"]) is True
        )
        assert (
            is_valid_image_format("test.jpg", allowed_formats=[".svg", ".png"]) is False
        )
    ...
    def test_is_valid_video_format(self):
        ...
        # Test with custom allowed formats
        assert (
            is_valid_video_format("test.flv", allowed_formats=[".flv", ".mp4"]) is True
        )
        assert (
            is_valid_video_format("test.mov", allowed_formats=[".flv", ".3gp"]) is False
        )

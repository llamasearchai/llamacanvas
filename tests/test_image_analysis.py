...
class TestImageClassification:
    ...
    def test_segment_image(self, color_image):
        ...
        with patch('llama_canvas.analysis.cv2') as mock_cv2:
            ...
            mock_ret, mock_labels, mock_stats, mock_centroids = True, np.zeros((5, 100, 100), dtype=np.int32), np.array([[0, 0, 0, 0, 0], [10, 10, 20, 20, 400]]), np.array([[0, 0], [20, 20]])
            mock_cv2.connectedComponentsWithStats.return_value = (mock_ret, mock_labels, mock_stats, mock_centroids)

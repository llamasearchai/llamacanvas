...
class TestWidgets:
    ...
    def test_file_dialog(self):
        ...
        with patch("llama_canvas.ui.tk") as mock_tk:
            ...
            assert (
                mock_tk.filedialog.asksaveasfilename.call_args[1]["initialdir"]
                == "/my/default/path"
            )
...
class TestCanvas:
    ...
    def test_canvas(self):
        ...
        # Test drawing shapes
        with patch.object(canvas, "_draw_line") as mock_line, patch.object(
            canvas, "_draw_rectangle"
        ) as mock_rect, patch.object(canvas, "_draw_ellipse") as mock_ellipse:
            ...
            canvas.draw_rectangle(
                50, 50, 100, 100, fill_color="#00FF00", outline_color="#000000"
            )
...
class TestInteractions:
    ...
    def test_tooltip(self):
        ...
        # Test show/hide
        with patch.object(tooltip, "_show") as mock_show, patch.object(
            tooltip, "_hide"
        ) as mock_hide:
...
class TestHelperFunctions:
    ...
    def test_show_dialog(self):
        ...
        with patch("llama_canvas.ui.Dialog") as mock_dialog:
            ...
            # Call helper function
            result = show_dialog(
                title="Test Dialog", message="This is a test dialog", dialog_type="info"
            )
    ...
    def test_file_dialogs(self):
        ...
        with patch("llama_canvas.ui.FileDialog") as mock_file_dialog:
            ...
            file_path = open_file_dialog(
                title="Open File", file_types=[("Text Files", "*.txt")]
            )
            ...
            assert mock_file_dialog.call_args[1]["file_types"] == [
                ("Text Files", "*.txt")
            ]

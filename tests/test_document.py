...
class TestDocumentStructure:
    ...
    def test_section(self):
        ...
        section_custom = Section(
            "Custom Section", level=2, title_font_size=18, title_alignment="center"
        )
...
class TestDocumentIO:
    ...
    def test_save_load_document(self, sample_document, tmp_path):
        ...
        # Load document
        with patch("llama_canvas.document.json") as mock_json, patch(
            "llama_canvas.document.Document"
        ) as mock_document:
...
class TestDocumentGenerator:
    ...
    def test_init(self):
        ...
        generator_custom = DocumentGenerator(template=template, stylesheet=stylesheet)
...
class TestTemplate:
    ...
    def test_init(self):
        ...
        template_dict = {
            ...
            "sections": [{"title": "Section Template", "elements": ["text"]}],
        }
    ...
    def test_apply(self):
        ...
        with patch("llama_canvas.document.Document") as mock_document, patch(
            "llama_canvas.document.Section"
        ) as mock_section, patch(
            "llama_canvas.document.TextElement"
        ) as mock_text_element:

...
class TestImageValidation:
    ...
    def test_validate_aspect_ratio(self):
        ...
        corrected_width, corrected_height = validate_aspect_ratio(600, 100, adjust=True, max_ratio=5.0)
        assert corrected_width == 500 or corrected_height == 120  # Either width reduced or height increased

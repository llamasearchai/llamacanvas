...
Thank you for your interest in contributing to LlamaCanvas! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaCanvas:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamacanvas.git
   cd llamacanvas
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamacanvas.git
   ```
...
By contributing to LlamaCanvas, you agree that your contributions will be licensed under the project's MIT License.
